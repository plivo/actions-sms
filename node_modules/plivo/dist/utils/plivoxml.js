...
exports.PlivoXMLError = undefined;
...
function Response() {
  ...
  this.nestables = ['Speak', 'Play', 'GetDigits', 'GetInput', 'Record', 'Dial', 'Message', 'Redirect', 'Wait', 'Hangup', 'PreAnswer', 'Conference', 'DTMF', 'MultiPartyCall'];
...
Response.prototype = {
   ...
   */
  addBreak: function addBreak(attributes) {
   ...
   */
  addEmphasis: function addEmphasis(body, attributes) {
   ...
   */
  addLang: function addLang(body, attributes) {
   ...
   */
  addPhoneme: function addPhoneme(body, attributes) {
   ...
   */
  addProsody: function addProsody(body, attributes) {
   ...
   */
  addSayAs: function addSayAs(body, attributes) {
   ...
   */
  addSub: function addSub(body, attributes) {
   ...
   */
  addW: function addW(body, attributes) {
   ...
   * @param {string} [attributes.customerHoldMusicUrl]
   */
  addMultiPartyCall: function addMultiPartyCall(body, attributes) {
    var VALID_ROLE_VALUES = ['agent', 'supervisor', 'customer'];
    var VALID_METHOD_VALUES = ['GET', 'POST'];
    var VALID_BOOL_VALUES = [true, false];
    var VALID_RECORD_FILE_FORMAT_VALUES = ['mp3', 'wav'];
